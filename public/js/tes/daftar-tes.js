const filterTes = document.getElementById("filter-tes");
const openFilter = filterTes.querySelector(".open-filter");

openFilter.addEventListener("click", handleFilterOpen);

function handleFilterOpen() {
  const filterContainer = filterTes.querySelector(".filter-container");
  const closeFilter = filterTes.querySelector(".close-filter");
...
const resetFilter = filterTes.querySelector(".reset-filter");
resetFilter.addEventListener("click", function () {
  const filterFields = filterTes.querySelectorAll(".filter-field");
